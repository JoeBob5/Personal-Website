  ...
  return(
    ...
    <article className="project-page">
      <nav className="navbar">
        ...
        <div>
          <Link target="_blank" href={ data[0].links.GitHub }>Code</Link>
          <Link target="_blank" href={ data[0].links.CodePen ? data[0].links.CodePen : data[0].links.Scrimba }>Demo</Link>
        </div>
      </nav>
      <p>Coming soon...</p>
      {/*
